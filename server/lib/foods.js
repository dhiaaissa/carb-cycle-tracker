/**
 * Food database — single source of truth for all ingredients.
 * Source: Tableau Alimentaire Nutritionnel (USDA & Ciqual)
 * All values per 100g unless unit is 'piece'/'pot'/'slice'.
 * Viandes · poissons · œufs · céréales · légumineuses = valeurs CUITES
 *
 * Amount units:
 *   'g'     → amount in grams, nutrition scaled from per-100g values
 *   'piece' → amount is count (e.g. eggs)
 *   'pot'   → amount is count (e.g. Yaarout 125g pot)
 */
...
export const FOODS = {
  ...
  escalope_poulet: {
    id: 'escalope_poulet',
    name: 'Escalope de poulet (cuite)',
    nameAr: 'شريحة دجاج مطبوخة',
    emoji: '🍗',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 165,
  ...
  steak_dinde: {
    id: 'steak_dinde',
    name: 'Steak de dinde (cuit)',
    nameAr: 'ستيك ديك رومي مطبوخ',
    emoji: '🥩',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 189,
  ...
  steak_poulet: {
    id: 'steak_poulet',
    name: 'Steak de poulet (cuit)',
    nameAr: 'ستيك دجاج مطبوخ',
    emoji: '🍗',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 158,
  ...
  poitrine_poulet_rotie: {
    id: 'poitrine_poulet_rotie',
    name: 'Poitrine de poulet rôtie',
  ...
  cuisse_poulet_rotie: {
    id: 'cuisse_poulet_rotie',
    name: 'Cuisse de poulet rôtie',
    nameAr: 'فخذ دجاج مشوي',
    emoji: '🍗',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 209,
  ...
  viande_hachee_5: {
    id: 'viande_hachee_5',
    name: 'Viande hachée 5% (cuite)',
    nameAr: 'لحم مفروم 5٪ مطبوخ',
    emoji: '🥩',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 172,
  ...
  viande_boeuf: {
    id: 'viande_boeuf',
    name: 'Viande de bœuf (cuite)',
    nameAr: 'لحم بقري مطبوخ',
    emoji: '🥩',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 250,
  ...
  osban_tripes: {
    id: 'osban_tripes',
    name: 'Osban / Tripes (cuit)',
    nameAr: 'أسبان كرشة مطبوخة',
    emoji: '🍖',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 100,
  ...
  eggs: {
    id: 'eggs',
    name: 'Oeuf entier cuit (~60g)',
    nameAr: 'بيضة كاملة مطبوخة',
    emoji: '🥚',
    category: 'proteines',
    unit: 'piece',
    kcal_per_unit: 89,
    protein_per_unit: 5.9,
    carbs_per_unit: 1.0,
    fat_per_unit: 6.6,
    default_amount: 2,
    step: 1,
  ...
  blanc_oeuf: {
    id: 'blanc_oeuf',
    name: 'Blanc d\'oeuf (cuit)',
    nameAr: 'بياض بيضة مطبوخ',
    emoji: '🥚',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 52,
  ...
  poisson_blanc: {
    id: 'poisson_blanc',
    name: 'Poisson blanc (cuit)',
    nameAr: 'سمك أبيض مطبوخ',
    emoji: '🐟',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 105,
  ...
  poisson_bleu: {
    id: 'poisson_bleu',
    name: 'Poisson bleu (cuit)',
    nameAr: 'سمك أزرق مطبوخ',
    emoji: '🐟',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 168,
  ...
  tuna_canned: {
    id: 'tuna_canned',
    name: 'Thon (sans huile)',
    nameAr: 'تونة بدون زيت',
    emoji: '🐟',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 116,
  ...
  sardine: {
    id: 'sardine',
    name: 'Sardine (sans huile)',
    nameAr: 'سردين بدون زيت',
    emoji: '🐟',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 208,
  ...
  fruit_de_mer: {
    id: 'fruit_de_mer',
    name: 'Fruit de mer (cuit)',
    nameAr: 'مأكولات بحرية مطبوخة',
    emoji: '🦑',
    category: 'proteines',
    unit: 'g',
    kcal_per_100g: 75,
  ...
  pates_integrales: {
    id: 'pates_integrales',
    name: 'Pâtes intégrales (cuites)',
    nameAr: 'معكرونة متكاملة مطبوخة',
    emoji: '🍝',
    category: 'glucides',
    unit: 'g',
    kcal_per_100g: 120,
  ...
  pates_sans_gluten: {
    id: 'pates_sans_gluten',
    name: 'Pâtes sans gluten (cuites)',
    nameAr: 'معكرونة بلا غلوتين',
    emoji: '🍝',
    category: 'glucides',
    unit: 'g',
    kcal_per_100g: 128,
  ...
  makrouna: {
    id: 'makrouna',
    name: 'Makrouna (cuites)',
    nameAr: 'مقرونة مطبوخة',
    emoji: '🍝',
    category: 'glucides',
    unit: 'g',
    kcal_per_100g: 131,
  ...
  boulgour_complet: {
    id: 'boulgour_complet',
    name: 'Boulgour complet (cuit)',
    nameAr: 'برغل كامل مطبوخ',
    emoji: '🌾',
    category: 'glucides',
    unit: 'g',
    kcal_per_100g: 83,
  ...
  haricot_rouge: {
    id: 'haricot_rouge',
    name: 'Haricot rouge (cuit)',
    nameAr: 'فول أحمر مطبوخ',
    emoji: '🫘',
    category: 'glucides',
    unit: 'g',
    kcal_per_100g: 127,
  ...
  foul_medames: {
    id: 'foul_medames',
    name: 'Foul medames (cuit)',
    nameAr: 'فول مدمس مطبوخ',
    emoji: '🫘',
    category: 'glucides',
    unit: 'g',
    kcal_per_100g: 110,
  ...
  yaarout: {
    id: 'yaarout',
    name: 'Yaourt 0%',
    nameAr: 'زبادي خالي الدسم 0٪',
    emoji: '🫙',
    category: 'laitiers',
    unit: 'pot',
    kcal_per_unit: 56,
    protein_per_unit: 5.25,
    carbs_per_unit: 7.25,
    fat_per_unit: 0.625,
    default_amount: 1,
    step: 1,
...
/**
 * Returns nutrition for one food item given its amount.
 * @param {string} foodId
 * @param {number} amount — grams or count, depending on food.unit
...
export function getNutrition(foodId, amount) {
  ...
  if (food.unit === 'g') {
    ...
    // piece / pot / slice
    return {
      kcal:      food.kcal_per_unit      * amount,
      protein_g: food.protein_per_unit   * amount,
      carbs_g:   food.carbs_per_unit     * amount,
      fat_g:     food.fat_per_unit       * amount,
    };
  }
}

/**
 * Sums nutrition across all items in a single meal array.
 * @param {Array<{food_id, amount}>} items
 */
...
/**
 * Calculates totals across all 4 meals from a mealsObj.
 * @param {{ meal1, meal2, meal3, meal4 }} mealsObj — each value is Array<{food_id, amount}>
 * @returns {{ calories_consumed, protein_g, carbs_g, fat_g, meal1_done, meal2_done, meal3_done, meal4_done }}
 */
